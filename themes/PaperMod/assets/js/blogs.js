// Blogs Page Interactive Features
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    blogCards.forEach(card => {
        card.addEventListener('click', function(e) {
            ...
            if (e.target === card || e.target.closest('.blog-title-link') || e.target.closest('.blog-image') || e.target.closest('.read-more-link')) {
    ...
    document.addEventListener('keydown', function(e) {
        ...
        if (focusedElement && focusedElement.classList.contains('blog-tag')) {
            const tags = Array.from(blogTags);
    ...
    // Add read more link hover effects
