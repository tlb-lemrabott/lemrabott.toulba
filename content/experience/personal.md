...
draft: false
tags: ["Java", "Spring Boot", "Spring Security", "JWT", "RESful APIs", "Hibernate", "MySQL", "PostgreSQL", "CI/CD", "Docker", "AWS Cloud", "RabbitMQ", "HTML", "CSS", "JavaScript", "Angular", "Github Actions", "Git", "Unix", "Trello"]
showToc: false
weight: 300
---
...
- Developed backend features for Mauribit’s Tybaa project, including authentication (sign-up, login, JWT, bcrypt, password reset), training management APIs, and CloudWatch metrics for monitoring.
...
- Designed and built a full-stack web application to track LeetCode progress for multiple users with administrative oversight, using Spring Boot, Angular, PostgreSQL, and Spring Security, Docker, Git, CI/CD, AWS ECS Fargate.
